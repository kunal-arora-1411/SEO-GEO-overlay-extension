...
keyword/phrase and up to 5 LSI (latent semantic indexing) keywords that
...
Return JSON:
{"primary": "primary keyword phrase", "lsi": ["keyword1", "keyword2"], "density": 0.02}
"""
